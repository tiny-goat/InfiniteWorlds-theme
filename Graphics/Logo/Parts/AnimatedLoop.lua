return Def.ActorFrame {
    ...
    Def.Sprite {
        Name="PlainLoop",
        Texture="iw_logo_4",
	InitCommand=function(self) self:zoom(4):rotationz(30):diffusetopedge(color("#16EEFF")):diffusebottomedge(color("#FF16EE")):sleep(0.1):easeoutexpo(1):rotationz(0):zoom(1) end
    },
