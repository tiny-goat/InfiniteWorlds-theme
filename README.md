...
**If you are upgrading from a previous version by `Download ZIP`, please fully delete the old folder first. Do not merge the new folder into the old.**

## Install Additions
Additionally with this theme, you can download this theme's own judgment fonts, grab 'em ![here!](https://github.com/tiny-goat/tiny-judgment-fonts)
